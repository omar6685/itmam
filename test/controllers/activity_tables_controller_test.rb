...
class ActivityTablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activity_table" do
    assert_difference("ActivityTable.count") do
      post activity_tables_url, params: { activity_table: { active: @activity_table.active, activity: @activity_table.activity, study_id: @activity_table.study_id } }
    end
  ...
  test "should update activity_table" do
    patch activity_table_url(@activity_table), params: { activity_table: { active: @activity_table.active, activity: @activity_table.activity, study_id: @activity_table.study_id } }
