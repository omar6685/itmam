class InspectionsController < ApplicationController
  ...
  private
    ...
    def inspection_params
      params.require(:inspection).permit(:company_name, :branchs_quantity, :company_status_id, :saudi_employees, :nonsaudi_employees, :salary_protection, :want_inspection, :personal_name, :phone_number, :email, :explanation)
    end
end
